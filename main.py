...
class OilBot:
    ...
    def init_binance(self):
        """Connect to Binance Futures Demo using demo=True."""
        try:
            # demo=True automatically sets the correct Futures Demo URLs
            self.client = Client(BINANCE_API_KEY, BINANCE_SECRET, demo=True)
